...
if (user == "51989"){ ## Bruno's PC path
  data = read.csv(paste0("C:/Users/51989/OneDrive/Escritorio/Dropbox/Default Tips Project/Data/Intermediate/fare_1218_recoded.csv"))
}
...
Below we estimate the optimal RDD models for values of B between 0.025 and 0.3

```{r, message=FALSE, warning=FALSE}
set.seed(1234)
ind = (X<18 & X>12) # Keeping those with fare between 14 and 16

for (i in seq(0.025, 0.3, by = 0.025)){
    # optrdd estimation
